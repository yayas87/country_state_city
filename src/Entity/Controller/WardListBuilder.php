...
/**
 * Provides a list controller for wardlist entity.
 *
 * @ingroup country_state_city
 */
class WardListBuilder extends EntityListBuilder {
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('Ward Entity implements a Ward model.'),
    ];
