 ...
 *
 * @FieldFormatter(
 *   id = "contry_state_city_formatter",
 *   label = @Translation("Contry state city formatter"),
 *   field_types = {
 *     "country_state_city_type"
 *   }
 * )
 */
class ContryStateCityFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
