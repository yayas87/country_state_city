 ...
 *
 * @FieldFormatter(
 *   id = "country_ISO2_formatter",
 *   label = @Translation("Contry ISO2 formatter"),
 *   field_types = {
 *     "country_type"
 *   }
 * )
 */
class ContryISO2Formatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[$delta] = [
        ...
        '#theme' => 'country',
        '#country' => !is_null($country) ? !empty($country->hasTranslation($langcode)) ? $country->getTranslation($langcode)->getIso2() : $country->getIso2() : '',
      ];
    }
