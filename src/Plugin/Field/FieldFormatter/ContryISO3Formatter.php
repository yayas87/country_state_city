 ...
 *
 * @FieldFormatter(
 *   id = "country_ISO3_formatter",
 *   label = @Translation("Contry ISO3 formatter"),
 *   field_types = {
 *     "country_type"
 *   }
 * )
 */
class ContryISO3Formatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[$delta] = [
        ...
        '#theme' => 'country',
        '#country' => !is_null($country) ? !empty($country->hasTranslation($langcode)) ? $country->getTranslation($langcode)->getIso3() : $country->getIso3() : '',
      ];
    }
